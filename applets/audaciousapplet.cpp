...
void audaciousApplet::update() {
    ...
    QDBusMessage m = QDBusMessage::createMethodCall((QString)"org.mpris.audacious",(QString)"/Player","",(QString)"GetStatus");
    ...
    if (!result.isValid()) {
        g15r_G15FPrint (canvas, (char *) "Audacious", 0, -4, G15_TEXT_HUGE, G15_JUSTIFY_CENTER, G15_COLOR_BLACK, 1);
        ...
        if (status == 2) g15r_G15FPrint (canvas, (char *) "Stopped", 0, 0, G15_TEXT_LARGE, G15_JUSTIFY_CENTER, G15_COLOR_BLACK, 2);
            ...
            m = QDBusMessage::createMethodCall((QString)"org.mpris.audacious",(QString)"/Player","",(QString)"GetMetadata");
